        ...
        success:function(data){
            ...
            if(data.code==0){
                ...
                for(var i=0; i<goods_list.length;i++){
                    ...
                    if(goods_list[i].goods_is_recommend==1){
                        lis+='<div class="school"><span>站长推荐</span></div>'+
                        ...
                        lis+='<div class="goods-attr"><p class="goods-name">'+goods_list[i].goods_name+'</p><span class="goods-price">¥'+goods_list[i].goods_price+'</span><span class="goods-address">'+goods_list[i].goods_trade_place+'</span></div></a></li>';
                    }
                }
